    ...
    <div className="px-4 pb-6">
      ...
      <div className="mt-5">
        ...
        <div className="grid grid-cols-4 gap-2">
          <div onClick={handleSendPayment} className="cursor-pointer">
            <QuickActionTile
              label="Send Payment"
              Icon={ArrowUpRight}
          ...
          <div onClick={handleSellGiftcard} className="cursor-pointer">
            <QuickActionTile
              label="Sell Giftcard"
              Icon={Gift}
          ...
          <div onClick={handleSellCrypto} className="cursor-pointer">
            <QuickActionTile
              label="Sell Crypto"
              Icon={Bitcoin}
