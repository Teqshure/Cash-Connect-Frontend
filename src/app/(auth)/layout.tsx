...
export default function AuthLayout({
  ...
  void pathname; // still available if needed
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen w-full font-sans overflow-x-hidden overflow-y-hidden pt-15 lg:pt-0">
      ...
      <div
        className="hidden lg:flex lg:w-1/2 h-full flex-col justify-center items-center bg-[#E8F5E9] p-12 relative overflow-hidden"
      >
